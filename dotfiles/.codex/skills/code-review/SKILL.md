---
name: code-review
description: Use when the user explicitly asks for a high-signal code review of a pull request or diff using the original Claude code-review workflow with triage, scoped AGENTS checks, bug detection, and issue validation.
---

# Code Review

Run the stricter staged review flow that mirrors the original Claude Code `code-review` command once invoked.
